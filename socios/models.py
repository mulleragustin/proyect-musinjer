...
class Socio(models.Model):
    ...
    created_by = models.ForeignKey(User, related_name='socio_created_by', on_delete=models.SET_NULL, null=True)
    modified_by = models.ForeignKey(User, related_name='socio_modified_by', on_delete=models.SET_NULL, null=True)
